...
function decodeUTXO(raw) {
  return {
          ...
          address: Caml_array.get(Json_decode.field("addresses", (function (param) {
...
function getUTXOs(config, addresses) {
  if (addresses) {
    return fetchAll("https://" + (config.subdomain + (".smartbit.com.au/v1/blockchain/address/" + (List.fold_left((function (res, a) {
                              return a + ("," + res);
